...
@Controller
@RequestMapping("/stuboard")
public class StuBoardController {

	private static final Logger logger=LoggerFactory.getLogger(StuBoardController.class);

	@Inject
	StuBoardService service;
	...
	public String registPOST(BoardVO boardVO, Model model){
		...
		return "redirect:/stuboard/listPage";
	}
