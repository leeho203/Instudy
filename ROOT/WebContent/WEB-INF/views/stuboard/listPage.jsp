...
<title>Study Board List Page</title>
...
<script>
		$(document).ready(function(){
			...
			$("#searchBtn").click(function(){
				self.location="/stuboard/listPage"
							...
							<c:forEach items="${list}" var="boardVO">
								<tr style="height:40px;">
									...
									<td align='left' style="vertical-align:middle; word-break:break-all;">
										<a href='/stuboard/read${pageMaker.makeSearchQuery(pageMaker.pageVO.page)}&bno=${boardVO.bno}'>${boardVO.title}</a>
